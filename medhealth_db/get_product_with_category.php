<?php  
    ...
    $cek_category = mysqli_query($conn, "SELECT * FROM category_product WHERE status ='on'");
    ...
    while ($row_category = mysqli_fetch_array($cek_category)) {
        ...
        $cek_product = mysqli_query($conn, "SELECT * FROM product WHERE id_category = '$id_category'");
